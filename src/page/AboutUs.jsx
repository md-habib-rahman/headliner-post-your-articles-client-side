    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-6xl mx-auto bg-white rounded-xl shadow-md p-6">
        ...
        <p className="text-gray-600 mb-6">
          ...
          insightful news. We are an independent digital news platform committed
          to delivering stories that matter — from breaking headlines and
          investigative journalism to features on politics, society, education,
          health, and beyond.
        </p>
